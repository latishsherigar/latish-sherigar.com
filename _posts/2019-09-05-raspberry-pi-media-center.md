...
using a old DVD player remote so that I could operate it without using a keyboard/mouse. In case you are interested in details of that build
...
Media –  A USB portable  hard disk which had my media files.

USB remote – The one i mentioned above

Display – HDMI output connected to TV.

Audio – USB to Optical / TOSLINK audio sound card which is then connected to my AV receiver.

Internet (Optional) – A USB WIFI adapter which can be used for installing additional software or getting updates.
